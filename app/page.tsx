...
export default function Home() {
  return (
    <main style={{ padding: 32, maxWidth: 640, fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 20, marginBottom: 8 }}>nextjs-mcp-kit — Dev Harness</h1>
      <p style={{ fontSize: 14, opacity: 0.75, marginBottom: 24 }}>
        Local test surfaces for the MCP server, MCP client, tool management, and chat interfaces.
      </p>
